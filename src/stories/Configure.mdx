...
Zid MUI is a UI library built on the MUI design system. It provides components, icons, hooks, and design tokens for building UIs that match Zid's brand.
...
Button	  .zid-button	  contained, outlined, text / primary, secondary, error / sm, md, lg
Input	.zid-input	sm, md, lg / error, disabled
Alert	.zid-alert	success, info, warning, error
Checkbox	.zid-checkbox	checked, disabled
Radio	.zid-radio	checked, disabled
Switch	.zid-switch	checked, disabled
Select	.zid-select	sm, md, lg
Card	.zid-card	—
Modal	.zid-modal	—
Table	.zid-table	—
Tooltip	.zid-tooltip	—
Status	.zid-status	—
List Item	.zid-list-item	—
Design tokens
All CSS variables are prefixed with --zid-:

/* Colors */
var(--zid-primary-main)
var(--zid-error-main)
var(--zid-text-primary)

/* Typography */
var(--zid-font-family)
var(--zid-font-size-base)
var(--zid-font-weight-medium)
