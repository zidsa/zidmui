  ...
  render: () => (
    <div style={{ padding: '24px', maxWidth: '900px', fontFamily: 'var(--zid-font-family)' }}>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--zid-text-secondary)' }}>
          Access typography via CSS variables: <code>var(--zid-font-&#123;property&#125;)</code>
        </p>
      </div>
      ...
      <div style={{ marginBottom: '48px' }}>
        ...
        <div
          style={{
            padding: '20px',
            background: 'var(--zid-base-neutral)',
            borderRadius: '8px',
            marginBottom: '16px',
          }}
        >
          <p style={{ fontSize: '24px', margin: 0 }}>IBM Plex Sans Arabic</p>
          <p style={{ fontSize: '14px', color: 'var(--zid-text-secondary)', margin: '8px 0 0 0' }}>
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                gap: '16px',
                padding: '12px 0',
                borderBottom: '1px solid var(--zid-divider)',
              }}
            >
              <div
                style={{
  ...
  render: () => (
    <div style={{ padding: '24px', maxWidth: '900px', fontFamily: 'var(--zid-font-family)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px' }}>
        ...
        >
          <div style={{ width: '120px', fontFamily: 'monospace', fontSize: '13px' }}>
            regular (400)
          </div>
          <div style={{ fontSize: '24px', fontWeight: 'var(--zid-font-weight-regular)', flex: 1 }}>
            The quick brown fox
          </div>
        </div>
        <div
        ...
        >
          ...
          <div style={{ fontSize: '24px', fontWeight: 'var(--zid-font-weight-medium)', flex: 1 }}>
            The quick brown fox
          </div>
        </div>
        <div
        ...
        >
          ...
          <div style={{ fontSize: '24px', fontWeight: 'var(--zid-font-weight-semibold)', flex: 1 }}>
            The quick brown fox
          </div>
        </div>
        <div
        ...
        >
          ...
          <div style={{ fontSize: '24px', fontWeight: 'var(--zid-font-weight-bold)', flex: 1 }}>
            The quick brown fox
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '48px' }}>
        <div>
          ...
          >
            <h1
              style={{
                fontSize: 'var(--zid-font-size-3xl)',
                fontWeight: 'var(--zid-font-weight-bold)',
                margin: '0 0 8px 0',
              }}
            >
              Dashboard Overview
            ...
            <p
              style={{
                fontSize: 'var(--zid-font-size-base)',
                color: 'var(--zid-text-secondary)',
                margin: 0,
              }}
            >
...
.page-subtitle {
  ...
  color: var(--zid-text-secondary);
        ...
        <div>
          ...
          <div
            className="zid-card zid-card--elevation-1"
            style={{ padding: '20px', marginBottom: '16px' }}
          >
            <h4
              style={{
                fontSize: 'var(--zid-font-size-lg)',
                fontWeight: 'var(--zid-font-weight-semibold)',
                margin: '0 0 8px 0',
              }}
            >
              Card Title
            ...
            <p
              style={{
                fontSize: 'var(--zid-font-size-sm)',
                color: 'var(--zid-text-secondary)',
                lineHeight: 'var(--zid-line-height-normal)',
                margin: 0,
              }}
            >
              This is the card description with proper typography settings applied.
            </p>
          </div>
          <pre
            style={{
