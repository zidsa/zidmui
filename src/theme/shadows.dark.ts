...
export const shadowsDark: ThemeOptions['shadows'] = [
  'none',
  '0px 1px 2px 0px rgba(0, 0, 0, 0.40)',
  '0px 1px 2px 0px rgba(0, 0, 0, 0.40), 0px 1px 3px 0px rgba(0, 0, 0, 0.45)',
  '0px 2px 4px -2px rgba(0, 0, 0, 0.40), 0px 4px 8px -2px rgba(0, 0, 0, 0.50)',
  '0px 2px 6px -2px rgba(0, 0, 0, 0.35), 0px 12px 16px -4px rgba(0, 0, 0, 0.50)',
  ...
  '0px 4px 5px -2px rgba(0, 0, 0, 0.20), 0px 7px 10px 1px rgba(0, 0, 0, 0.14), 0px 2px 16px 1px rgba(0, 0, 0, 0.12)',
  // Additional shadows for MUI compatibility (9-24)
