    ...
    alert: {
      standard: {
        error: {
          ...
          background: alpha(colors.red[1000], 0.6),
          icon: colors.red[900],
        },
        warning: {
          color: colors.base.white,
          border: colors.yellow[900],
          background: alpha(colors.yellow[1000], 0.6),
          icon: colors.yellow[900],
        },
        info: {
          color: colors.base.white,
          border: colors.blue[900],
          background: alpha(colors.blue[1000], 0.6),
          icon: colors.blue[900],
        },
        success: {
          color: colors.base.white,
          border: colors.green[900],
          background: alpha(colors.green[1000], 0.6),
          icon: colors.green[900],
        },
        primary: {
          color: colors.base.white,
          border: colors.primary[900],
          background: alpha(colors.primary[1000], 0.6),
          icon: colors.primary[900],
        },
        gray: {
          color: colors.base.white,
          border: colors.neutral[500],
          background: alpha(colors.neutral[400], 0.1),
